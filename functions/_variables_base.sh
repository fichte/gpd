...
{
	STACK_BASE_VARIABLES_KEY=("STACK_ENV" "STACK_ENV_LOWER" "STACK_PATH" "STACK_COMPOSE_PATH" "STACK_CONFIG_PATH" "STACK_DATA_PATH")
	STACK_BASE_VARIABLES_VALUE=("${STACK_ENV}" "${STACK_ENV_LOWER}" "${STACK_PATH}" "${STACK_COMPOSE_PATH}" "${STACK_CONFIG_PATH}" "${STACK_DATA_PATH}")
