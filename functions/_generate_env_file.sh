...
COMPOSE_PROJECT_NAME=${ENVIRONMENT}-${STACK_NAME}
COMPOSE_FILE=${STACK_COMPOSE_PATH}/stack-common.yml:${STACK_COMPOSE_PATH}/stack.yml:${STACK_COMPOSE_PATH}/stack-extend.yml
